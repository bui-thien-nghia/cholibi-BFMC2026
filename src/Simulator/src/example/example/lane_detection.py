...
class LaneDetector:
    def __init__(self, 
        ...
        src = np.float32([
            [img_w * 0.4, img_h * 0.20],  # Top Left (Narrower)
            [img_w * 0.6, img_h * 0.20],  # Top Right
    ...
    def preprocess(self, img):
        ...
        # Filter for bright white (modified for white lines)
        s_binary = np.zeros_like(s_channel)
        # White lines have HIGH Lightness and LOW Saturation. 
        # We just check for high lightness here.
        s_binary[(l_channel > 140)] = 1 
