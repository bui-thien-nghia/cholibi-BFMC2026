car-only:
    ./ros_exec.sh ros2 launch sim_pkg map_with_car.launch
...
all-objects:
    ...
    ./ros_exec.sh ros2 launch sim_pkg map_with_car.launch &
    sleep 5
    ./ros_exec.sh ros2 launch sim_pkg all_objects.launch &
    wait

control_example:
    ./ros_exec.sh ros2 run example control

camera_example:
    ./ros_exec.sh ros2 run example camera
