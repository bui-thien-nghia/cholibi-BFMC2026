...
#include "bfmc_interfaces/msg/detail/control__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const bfmc_interfaces::msg::Control & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  bfmc_interfaces::msg::Control & ros_message)
{
  // Member: velocity
  cdr >> ros_message.velocity;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = bfmc_interfaces::msg::Control;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const bfmc_interfaces::msg::Control *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<bfmc_interfaces::msg::Control *>(
    untyped_ros_message);
...
{
  return &bfmc_interfaces::msg::typesupport_fastrtps_cpp::_Control__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, bfmc_interfaces, msg, Control)() {
  return &bfmc_interfaces::msg::typesupport_fastrtps_cpp::_Control__handle;
}
