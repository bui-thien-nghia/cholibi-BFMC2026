...
static const _SerialStatus_type_support_symbol_names_t _SerialStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, bfmc_interfaces, msg, SerialStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, bfmc_interfaces, msg, SerialStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, bfmc_interfaces, msg, SerialStatus)() {
  return &::bfmc_interfaces::msg::rosidl_typesupport_c::SerialStatus_message_type_support_handle;
}
