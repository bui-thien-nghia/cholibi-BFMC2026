...
bool bfmc_interfaces__msg__control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bfmc_interfaces.msg._control.Control", full_classname_dest, 36) == 0);
  }
  bfmc_interfaces__msg__Control * ros_message = _ros_message;
  {  // velocity
...
PyObject * bfmc_interfaces__msg__control__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("bfmc_interfaces.msg._control");
