...
bfmc_interfaces__msg__Control__create()
{
  ...
  bfmc_interfaces__msg__Control * msg = (bfmc_interfaces__msg__Control *)allocator.allocate(sizeof(bfmc_interfaces__msg__Control), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(bfmc_interfaces__msg__Control));
  bool success = bfmc_interfaces__msg__Control__init(msg);
  if (!success) {
...
bfmc_interfaces__msg__Control__destroy(bfmc_interfaces__msg__Control * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    bfmc_interfaces__msg__Control__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
bfmc_interfaces__msg__Control__Sequence__init(bfmc_interfaces__msg__Control__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bfmc_interfaces__msg__Control * data = NULL;

  if (size) {
    data = (bfmc_interfaces__msg__Control *)allocator.zero_allocate(size, sizeof(bfmc_interfaces__msg__Control), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = bfmc_interfaces__msg__Control__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        bfmc_interfaces__msg__Control__fini(&data[i - 1]);
      }
...
bfmc_interfaces__msg__Control__Sequence__fini(bfmc_interfaces__msg__Control__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      bfmc_interfaces__msg__Control__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  bfmc_interfaces__msg__Control__Sequence * array = (bfmc_interfaces__msg__Control__Sequence *)allocator.allocate(sizeof(bfmc_interfaces__msg__Control__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = bfmc_interfaces__msg__Control__Sequence__init(array, size);
  if (!success) {
...
bfmc_interfaces__msg__Control__Sequence__destroy(bfmc_interfaces__msg__Control__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    bfmc_interfaces__msg__Control__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
bfmc_interfaces__msg__Control__Sequence__are_equal(const bfmc_interfaces__msg__Control__Sequence * lhs, const bfmc_interfaces__msg__Control__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!bfmc_interfaces__msg__Control__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  bfmc_interfaces__msg__Control__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(bfmc_interfaces__msg__Control);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    bfmc_interfaces__msg__Control * data =
      (bfmc_interfaces__msg__Control *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!bfmc_interfaces__msg__Control__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          bfmc_interfaces__msg__Control__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!bfmc_interfaces__msg__Control__copy(
